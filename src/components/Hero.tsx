      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-28 pb-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-0">
          ...
          <div className="relative z-30 lg:col-span-7 space-y-6 lg:pr-0">
            ...
            {/* Main Headline */}
            <h1 className="font-black uppercase leading-tight tracking-tight text-3xl sm:text-4xl lg:text-[2.5rem] xl:text-[3.1rem]">
              <span className="block text-white">
                {t.headline1}
              </span>
              <span className="block gold-gradient-text mt-1 whitespace-nowrap drop-shadow-lg">
                {t.headline2}
              </span>
            </h1>
